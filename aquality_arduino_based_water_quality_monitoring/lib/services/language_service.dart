...
class AppTranslations {
  static const Map<String, Map<String, String>> _translations = {
    'en': {
      ...
      'device_registered': 'device(s) registered',
      'add_device': 'Add Device',
      'no_devices': 'No devices yet',
      'threshold_rules': 'Threshold Rules',
      'active_rules': 'active rule(s)',
      'add_rule': 'Add Rule',
      'add_threshold_rule': 'Add Threshold Rule',
      'no_rules': 'No rules yet',
      'remote_commands': 'Remote Commands',
      'command_sent': 'command(s) sent',
      'send_test_command': 'Send test command',
      'send_command': 'Send Command',
      'command_log': 'Command Log',
      'no_commands': 'No commands sent yet',
      'toggle': 'Toggle',
      'disable': 'Disable',
      'enable': 'Enable',
      ...
      'device_disabled_label': 'Device Disabled',
      'last_seen': 'Last seen:',
      'id': 'ID:',
      'send_command_to': 'Send command to',
      'are_you_sure': 'Are you sure you want to delete the rule',
      'note_device': 'Note: Device:',
    ...
    'tl': {
      ...
      'rules': 'Mga Patakaran',
      'commands': 'Mga Utos',
      'connected_devices': 'Mga Konektadong Aparato',
      'device_registered': 'na-register na device(s)',
      'add_device': 'Magdagdag ng Aparato',
      'no_devices': 'Walang mga aparato pa',
      'threshold_rules': 'Mga Patakaran sa Threshold',
      'active_rules': 'aktibong patakaran(s)',
      'add_rule': 'Magdagdag ng Patakaran',
      'add_threshold_rule': 'Magdagdag ng Patakaran sa Threshold',
      'no_rules': 'Walang mga patakaran pa',
      'remote_commands': 'Mga Utos sa Malayo',
      'command_sent': 'utos na ipinadala',
      'send_test_command': 'Magpadala ng test command',
      'send_command': 'Magpadala ng Utos',
      'command_log': 'Utos Log',
      'no_commands': 'Walang mga utos na ipinadala pa',
      'toggle': 'I-toggle',
      'disable': 'I-disable',
      'enable': 'I-enable',
      'delete_rule': 'Burahin ang Patakaran?',
      'delete_device': 'Burahin ang Aparato?',
      'rule_deleted': 'Naburahin ang patakaran',
      'device_deleted': 'Naburahin ang aparato',
      'device_enabled': 'Naka-enable ang aparato',
      'device_disabled': 'Na-disable ang aparato',
      'device_disabled_label': 'Na-disable na Aparato',
      'last_seen': 'Huling nakita:',
      'id': 'ID:',
      'send_command_to': 'Magpadala ng utos sa',
      'are_you_sure': 'Sigurado ka na ba na gusto mong burahin ang patakaran',
      'note_device': 'Paalala: Aparato:',
      'rule_added': 'Nagdagdag ng patakaran',
      'sent_just_now': 'Ipinadala ngayon lang',
      'online': 'ONLINE',
      'offline': 'OFFLINE',
    },
  };
